...
var BBCFeeds = JSON.parse(fs.readFileSync('./config/feed/BBCRSSFeed.json'));
BBCFeeds.forEach(function (element) {
    fetch(element.url, null, printFeedHandler(element.siteId, element.boardId));
});
